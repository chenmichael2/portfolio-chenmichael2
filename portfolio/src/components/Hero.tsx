  ...
  return (
    <section className="pt-14 w-full h-[calc(100vh-1rem)] bg-gray-50">
      <div className="relative overflow-hidden w-full h-full">
        ...
        md:scale-170 md:translate-y-7" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        sm:scale-150
        md:scale-170 md:translate-y-20" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        md:scale-160 md:translate-y-85" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
