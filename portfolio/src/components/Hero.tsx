    ...
    <section className="pt-14 w-full min-h-215 h-[calc(100vh-2rem)] max-h-230 bg-gray-50">
      ...
      lg:flex lg:flex-row-reverse">
        <div className="lg:flex lg:w-full lg:h-full lg:justify-center lg:items-center lg:relative lg:overflow-hidden">
          <svg className="absolute w-100 h-100 overflow-hidden left-1/2 -translate-x-1/2 top-10 scale-200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="absolute w-100 h-100 overflow-hidden left-1/2 -translate-x-1/2 top-45 scale-200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="absolute w-100 h-100 z-11 overflow-hidden left-1/2 -translate-x-1/2 top-100 scale-150" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
