  ...
  return (
    <section className="pt-15 w-full h-[calc(100vh-2rem)] bg-gray-50">
      <div className="relative overflow-x-hidden w-full h-full">
        ...
        <svg className="absolute z-41 w-100 h-100 overflow-hidden left-1/2 -translate-x-1/2 translate-y-40" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <Image
          ...
          width={300} 
          height={300}
          className="absolute rounded-xl z-40 left-1/2 -translate-x-1/2 -translate-y-15"
        />
      </div>
    </section>
  );
