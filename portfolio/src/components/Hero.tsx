    ...
    <section className=" w-full min-h-240 h-[calc(100vh-1rem)] max-h-300 bg-gray-50">
      ...
      md:flex-row-reverse md:justify-evenly">
        ...
        md:h-full">
          ...
          md:translate-y-0 md:w-100" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          md:translate-y-0 md:w-100 md:rotate-45" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
