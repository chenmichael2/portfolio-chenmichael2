  ...
  return (
    <section className="pt-15 w-full h-[calc(100vh-2rem)] bg-gray-50">
      <div className="relative overflow-x-hidden w-full h-full">
        <div className={`${openSauce.className} absolute z-12 text-secondary text-5xl font-medium flex flex-col w-full p-6 text-center translate-y-60`}>
        ...
        <svg className="absolute w-100 h-100 overflow-hidden left-1/2 -translate-x-42 translate-y-0" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="absolute z-11 w-100 h-100 overflow-hidden left-1/2 -translate-x-1/2 translate-y-30 scale-80" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
