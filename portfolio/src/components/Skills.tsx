...
export default function Skills() {
  const languages = [
    ...
    {alt: "Python", icon: "/icons/technologies/Light/python.svg", name:""},
    {alt: "PostgreSQL", icon: "/icons/technologies/Light/postgresql.svg", name:""},
    {alt: "JSON", icon: "/icons/technologies/Light/json.svg", name:""},
    {alt: "Angular.js", icon: "/icons/technologies/Light/angular.svg", name:""},
    {alt: "React", icon: "/icons/technologies/Light/react.svg", name:""},
    {alt: "Next.js", icon: "/icons/technologies/Light/nextjs.svg", name:""},
    {alt: "Material UI", icon: "/icons/technologies/Light/materialui.svg", name:""},
    {alt: "jQuery", icon: "/icons/technologies/Light/jquery.svg", name:""},
    {alt: "Express", icon: "/icons/technologies/Light/express.svg", name:""},
    {alt: "Django", icon: "/icons/technologies/Light/django.svg", name:""},
    {alt: "MongoDB", icon: "/icons/technologies/Light/mongodb.svg", name:""},
