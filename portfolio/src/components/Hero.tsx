    ...
    <section className=" w-full min-h-215 h-[calc(100vh-2rem)] max-h-280 bg-gray-50">
      ...
      md:flex-row-reverse md:justify-evenly">
        ...
        md:h-full">
          ...
          />
          <svg className="absolute z-5 w-200 overflow-hidden left-1/2 -translate-x-1/2 translate-y-60 
          md:-translate-y-60" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="absolute z-6 w-200 overflow-hidden left-1/2 -translate-x-1/2 translate-y-80 
          md:-translate-y-80 md:rotate-45" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="absolute z-11 w-100 overflow-hidden left-1/2 -translate-x-1/2 translate-y-130 
          md:-translate-y-65" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
