...
export default function ExpCard({ id, title, dates, jobTitle, description, top, logo }: ExpCardProp) {
    ...
    return (
        <div
            style={{ marginTop }}
            id={`${id}`}
            className="exp-card self-start border-1 border-[#ccc] bg-white rounded-md shadow-sm p-2 pt-4 px-4 bg-neutral-primary-soft transition-all duration-300"
        >
