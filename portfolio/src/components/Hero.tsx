  ...
  return (
    <section className="pt-15 w-full h-[calc(100vh-2rem)] bg-gray-50">
      <div className="relative overflow-x-hidden w-full h-full">
        <div className={`${openSauce.className} absolute z-12 text-secondary text-5xl font-medium flex flex-col w-full p-6 text-center translate-y-76`}>
        ...
        <svg className="absolute w-100 h-100 overflow-hidden left-1/2 -translate-x-1/2 -translate-y-7" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="absolute w-100 h-100 overflow-hidden left-1/2 -translate-x-42 rotate-90 translate-y-20" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="absolute z-11 w-100 h-100 overflow-hidden left-1/2 -translate-x-1/2 translate-y-40" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <Image
          ...
          width={300} 
          height={300}
          className="absolute rounded-xl z-10 left-1/2 -translate-x-1/2 -translate-y-15"
        />
      </div>
    </section>
  );
