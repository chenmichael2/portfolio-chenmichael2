...
export default function Header() {
    ...
    return (
        <div>
            ...
            <nav className={`mobile-dropdown ${poppins.className} fixed w-full h-[calc(100vh-4rem)] bg-transparent z-20 top-0 -translate-y-400 transition-transform duration-300
