    ...
    <section className=" w-full min-h-240 h-[calc(100vh-1rem)] max-h-300 bg-gray-50 mt-15">
      ...
      md:flex-row-reverse md:justify-evenly">
        ...
        lg:w-[50%]">
          ...
          lg:scale-220" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          lg:scale-180" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          lg:scale-130 lg:translate-y-50" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
