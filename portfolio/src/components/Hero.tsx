...
export default function Hero() {
  ...
  return (
    <section className="pt-14 w-full h-[calc(100vh-2rem)] bg-gray-50">
      ...
      lg:flex lg:flex-row-reverse">
        <div className="lg:flex lg:w-full lg:h-full lg:justify-center lg:items-center lg:relative lg:overflow-hidden">
          ...
          sm:scale-150
          md:scale-170
          lg:block lg:w-1/2 lg:left-auto lg:translate-x-0 lg:scale-150" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="absolute w-100 h-100 z-11 overflow-hidden left-1/2 -translate-x-1/2 top-90 scale-90 rotate-180" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="absolute w-100 h-100 z-11 overflow-hidden left-1/2 -translate-x-1/2 bottom-10 scale-150
          sm:scale-120
          md:scale-160
          lg:block lg:w-1/2 lg:left-auto lg:translate-x-0 lg:scale-130" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <img
            ...
            lg:block lg:left-auto lg:translate-x-0 lg:scale-100"
          />
        </div>
        <div className={`${openSauce.className} relative z-12 h-full w-full flex flex-col justify-end align-center pt-6 pb-28 text-center mt-10
        sm:translate-y-80
        md:translate-y-90
        lg:translate-y-0`}>
