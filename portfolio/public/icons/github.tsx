...
export default function GithubIcon({ icon }: IconProps) {
    ...
    >
        <svg onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M7.49996 15C3.74163 16.6666 3.33329 13.3333 1.66663 13.3333" stroke="black" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        </a>
    )
}