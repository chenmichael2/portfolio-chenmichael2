    ...
    <section id="about" className="flex flex-col items-center justify-center w-full bg-gray-50
      ...
      <div>
        <div className="mb-5 py-5">
          ...
          sm:grid-cols-4
          md:grid-cols-5
          lg:flex lg:flex-wrap lg:justify-center lg:px-20 lg:max-w-7xl">
            {languages.map((lang, index) => (
              <div key={index} className="flex flex-col justify-center items-center m-4">
                ...
                <div className="border-1 px-2 mt-1 text-xs rounded-md backdrop-blur-3xl whitespace-nowrap
                sm:text-sm
                md:text-md">{lang.name}</div>
              </div>
            ))}
          </div>
        </div>
