...
export default function Hero() {
  ...
  return (
    <section className="pt-14 w-full h-[calc(100vh-1rem)] bg-gray-50">
      <div className="relative overflow-hidden w-full h-full 
      lg:flex lg:flex-row-reverse">
        <div className="lg:flex lg:w-full lg:h-full lg:justify-center lg:items-center lg:relative lg:overflow-hidden">
          <svg className="absolute w-100 h-100 overflow-hidden left-1/2 -translate-x-1/2 -translate-y-7 scale-130
          sm:scale-150 sm:-translate-y-2
          md:scale-170 md:translate-y-7
          lg:block lg:w-1/2 lg:left-auto lg:translate-x-0 lg:translate-y-0 lg:scale-150" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="absolute w-100 h-100 overflow-hidden left-1/2 -translate-x-42 translate-y-0 scale-130
          sm:scale-150
          md:scale-170 md:translate-y-20
          lg:block lg:w-1/2 lg:left-auto lg:translate-x-0 lg:translate-y-50 lg:scale-150" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="absolute w-100 h-100 overflow-hidden left-1/2 -translate-x-1/2 translate-y-50 scale-120 z-11
          sm:scale-120 sm:translate-y-65
          md:scale-160 md:translate-y-85
          lg:block lg:w-1/2 lg:left-auto lg:translate-x-0 lg:translate-y-115 lg:scale-130" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <Image
            ...
            sm:-translate-y-25
            md:-translate-y-35
            lg:block lg:left-auto lg:translate-x-0 lg:-translate-y-30 lg:scale-100"
          />
        </div>
