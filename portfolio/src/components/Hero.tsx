...
export default function Hero() {
  ...
  return (
    <section className=" w-full min-h-215 h-[calc(100vh-2rem)] max-h-280 bg-gray-50">
      <div className="flex justify-center align-center flex-col relative overflow-hidden w-full h-full
      ">
        <div className="flex flex-col h-140">
          ...
          />
          <svg className="relative z-5 w-100 h-100 overflow-hidden left-1/2 -translate-x-1/2 translate-y-60 scale-370" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="relative z-6 w-100 h-100 overflow-hidden left-1/2 -translate-x-1/2 translate-y-30 scale-370" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="relative w-100 h-100 z-11 overflow-hidden left-1/2 -translate-x-1/2 translate-y-40 scale-370" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
