    ...
    <section className="pt-14 w-full h-[calc(100vh-1rem)] bg-gray-50">
      ...
      lg:flex lg:flex-row-reverse">
        <div className="lg:flex lg:w-full">
          ...
          lg:block lg:left-auto lg:translate-x-0 lg:translate-y-0 lg:scale-100" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <Image
            ...
            sm:-translate-y-25
            md:-translate-y-35
            lg:block lg:left-auto lg:translate-x-0 lg:translate-y-0 lg:scale-100"
          />
        </div>
