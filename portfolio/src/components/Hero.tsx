    ...
    <section className=" w-full min-h-240 h-[calc(100vh-1rem)] max-h-300 bg-gray-50 mt-15">
      ...
      md:flex-row-reverse md:justify-between">
        ...
        md:relative md:h-full md:w-full md:justify-center">
          ...
          md:relative md:-translate-y-90 md:w-100 md:scale-165" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          md:translate-y-14 md:ml-22 md:w-100 md:scale-130" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          md:translate-y-40 md:w-100" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
