  ...
  return (
    <section className="flex flex-col justify-evenly w-full h-[calc(100vh-100px)] bg-gray-50">
      <div className={`${poppins.className} flex items-center justify-evenly leading-none w-full`}>
        ...
        <div className="fixed right-30 inline-block z-50 overflow-hidden w-100 h-100 border-1 border-neutral-300 shadow-2xl rounded-full hover:scale-105 transition-all duration-300 ease-in-out">
